...
from models import Checkin, CheckinAnswer, TeamQuestion, User, Team, TeamMember, Blocker
from schemas import (
...
from scheduler import send_daily_emails
...
async def get_checkin_by_token(token: str, db: AsyncSession = Depends(get_db)):
    ...
    from routers.teams import _ensure_team_questions
    if team:
...
async def submit_checkin(
    ...
    checkin.submitted_at = datetime.utcnow()
    db.add(checkin)
